...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = '<b>💠SuperGroup has been added!(4.0)💠</b>'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = '<b>💠SuperGroup has been removed!(4.0)💠</b>'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if not is_owner(msg) then
    return reply_msg(msg.id,"<b>💠*Owners only!💠</b>", ok_cb, false)
  end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == '🔐' then
    return reply_msg(msg.id,"<b>>> 💠#Arabic/Persian is #already locked💠</b>", ok_cb, false)
  else
...
local function promote2(receiver, member_username, user_id)
  ...
  data[group]['moderators'][tostring(user_id)] = member_tag_username
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' <i>has been </i><b>💠promoted💠.</b>')
end
...
function get_message_callback(extra, success, result)
	...
	elseif get_cmd == 'mute_user' then
		...
		if is_muted_user(chat_id, user_id) then
			...
			send_large_msg(receiver, "💠[<i>"..user_id.."</i>] <b>removed from the muted user list💠</b>")
  ...
  elseif get_cmd == "invite" then
	...
	elseif get_cmd == 'mute_user' then
		...
		elseif is_owner(extra.msg) then
			mute_user(chat_id, user_id)
			send_large_msg(receiver, "<b>💠 ["..user_id.."] added to muted user list💠</b>")
		end
	end
end
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == "owner" then
			...
			return "💠SuperGroup owner💠 is <b>>> ["..group_owner..']</b>'
		end
		...
		if matches[1] == 'clean' then
            ...
            savelog(msg.to.id, name_log.." ["..msg.from.id.."] kicked all SuperGroup bots")
				...
				return reply_msg(msg.id,"<b>💠All Bots Are Removed💠 From</b> " ..string.gsub(msg.to.print_name, "_", " "), ok_cb,false)
			end
		...
		if matches[1] == 'mute' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if not is_muted(chat_id, msg_type..': yes') then
					...
					return "<b>💠Audio has been muted💠</b>"
				else
					return "<b>💠SuperGroup mute Audio is already on💠</b>"
				end
			end
			if matches[2] == 'photo' then
			local msg_type = 'Photo'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Photo has been muted💠</b>"
				else 
					return "<b>💠Mute Photo is already on💠</b>"
				end
			end
			if matches[2] == 'video' then
			local msg_type = 'Video'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Video has been muted💠</b>"
				else
					return "<b>💠SuperGroup mute Video is already on💠</b>"
				end
			end
			...
			local msg_type = 'Gifs'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Gifs have been muted💠</b>"
				else
					return "<b>💠SuperGroup mute Gifs is already on💠</b>"
				end
			end
			...
			local msg_type = 'Documents'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Documents have been muted💠</b>"
				else
					return "<b>💠SuperGroup mute Documents is already on💠</b>"
				end
			end
			...
			local msg_type = 'Text'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Text has been muted💠</b>"
				else
					return "<b>💠Mute Text is already on💠</b>"
				end
			end
			...
			local msg_type = 'All'
				if not is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type)
					mute(chat_id, msg_type)
					return "<b>💠Mute ALL  has been enabled💠</b>"
				else
					return "<b>💠Mute ALL is already on💠</b>"
				end
			end
		end
		if matches[1] == 'unmute' and is_momod(msg) then
			...
			local msg_type = 'Audio'
				if is_muted(chat_id, msg_type..': yes') then
					...
					return "<b>💠Audio has been unmuted💠</b>"
				else
					return "<b>💠Mute Audio is already off💠</b>"
				end
			end
			if matches[2] == 'photo' then
			local msg_type = 'Photo'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return "<b>💠Photo has been unmuted💠</b>"
				else
					return "<b>💠Mute Photo is already off💠</b>"
				end
			end
			if matches[2] == 'video' then
			local msg_type = 'Video'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return "<b>💠Video has been unmuted💠</b>"
				else
					return "<b>💠Mute Video is already off💠</b>"
				end
			end
			if matches[2] == 'gifs' then
			local msg_type = 'Gifs'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return "<b>💠Gifs have been unmuted💠</b>"
				else
					return "<b>💠Mute Gifs is already off💠</b>"
				end
			end
			if matches[2] == 'documents' then
			local msg_type = 'Documents'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return "<b>💠Documents have been unmuted💠</b>"
				else
					return "<b>💠Mute Documents is already off💠</b>"
				end
			end
			if matches[2] == 'text' then
			local msg_type = 'Text'
				if is_muted(chat_id, msg_type..': yes') then
					...
					unmute(chat_id, msg_type)
					return "<b>💠Text has been unmuted💠</b>"
				else
			...
			local msg_type = 'All'
				if is_muted(chat_id, msg_type..': yes') then
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type)
					unmute(chat_id, msg_type)
					return "<b>>> 💠Mute ALL has been disabled💠</b>"
				else
					return "<b>>> 💠Mute ALL is already disabled💠</b>"
				end
			end
		end
